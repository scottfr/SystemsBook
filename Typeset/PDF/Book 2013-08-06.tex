...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_1/result_5.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_2/result_5.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_3/result_11.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_5/result_6.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_5/result_9.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_6/result_5.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_8/diagram_3.png}
\end{minipage}
...
\p{Stock} and \p{Flow} \u{Primitives} on a blank canvas and naming them.
You can remove a \u{Primitive} by clicking on it to select it and then
pressing the \u{Delete} key or clicking the \u{Delete} function in the
\u{Actions} section of the \u{Toolbar}.
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_9/diagram_11.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_9/diagram_28.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_10/diagram_11.png}
\end{minipage}


\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_10/result_12.png}
\end{minipage}
...
\hyperdef{}{Ex-4-4}{\paragraph{}\label{Ex-4-4}}
...
\hfill{} \hyperref[Ans-4-4]{Answer Available}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_11/diagram_3.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_11/diagram_13.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_11/result_15.png}
\end{minipage}
...
\hyperdef{}{Ex-4-6}{\paragraph{}\label{Ex-4-6}}
...
\hfill{} \hyperref[Ans-4-6]{Answer Available}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_12/diagram_7.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_12/diagram_14.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_12/result_28.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_13/diagram_3.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_13/result_5.png}
\end{minipage}
...
\textbf{\p{Work} = IfThenElse(\p{Work Remaining} > \p{Workers},\p{Workers},\p{Work Remaining})}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_14/diagram_2.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_15/diagram_2.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_16/diagram_2.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_17/diagram_10.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_18/result_9.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_19/diagram_6.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_19/result_9.png}
\end{minipage}
...
\hyperdef{}{Ex-6-3}{\paragraph{}\label{Ex-6-3}}
...
\hfill{} \hyperref[Ans-6-3]{Answer Available}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_20/diagram_17.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_20/result_19.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_21/diagram_24.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_21/result_32.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_22/result_12.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_22/result_16.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_23/result_5.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_24/result_5.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_25/diagram_2.png}
\end{minipage}
...
\hyperdef{}{Ex-6-4}{\paragraph{}\label{Ex-6-4}}
...
\hfill{} \hyperref[Ans-6-4]{Answer Available}
...
\hyperdef{}{Ex-6-5}{\paragraph{}\label{Ex-6-5}}
...
\hfill{} \hyperref[Ans-6-5]{Answer Available}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_27/result_5.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_28/result_8.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_28/result_11.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_28/result_14.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_28/result_17.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_28/result_20.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_29/diagram_3.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_29/result_7.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_29/result_10.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_30/diagram_3.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_30/result_7.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_30/result_10.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_31/diagram_3.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_31/result_6.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_31/result_10.png}
\end{minipage}
...
\item  Change the \a{Equation} property of the primitive \p{side effect fact} to \e{0.2}.


\item  Change the \a{Simulation Length} property of the Time Settings to \e{20}.


\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_31/result_15.png}
\end{minipage}
...
The result shows that with the development of the \p{Side Effect} depresses the development of the \p{Fundamental Solution}. The result of this is that the \p{symptomatic solution} has to be repeatedly applied though at a declining frequency. It is expected that if we look at a longer period of time the \p{Fundamental Solution} would develop to a point where the \p{symptomatic solution} will no longer need to be applied.
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_32/diagram_3.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_32/result_6.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_32/result_9.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_32/result_12.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_33/result_6.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_33/result_11.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_34/result_5.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_34/result_10.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_35/diagram_2.png}
\end{minipage}
...
\begin{figure}[htbp]
\centering
\includegraphics{ap-im-1366.png}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_36/diagram_11.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_36/result_13.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_36/result_21.png}
\end{minipage}
...
\item \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_36/data_25.png}
\end{minipage}
...
\hyperdef{}{Ex-12-6}{\paragraph{}\label{Ex-12-6}}
...
\hfill{} \hyperref[Ans-12-6]{Answer Available}
...
\hyperdef{}{Ex-14-1}{\paragraph{}\label{Ex-14-1}}
...
\hfill{} \hyperref[Ans-14-1]{Answer Available}
...
\hyperdef{}{Ex-14-3}{\paragraph{}\label{Ex-14-3}}
...
\hfill{} \hyperref[Ans-14-3]{Answer Available}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_37/result_17.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_37/result_26.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/diagram_7.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/result_15.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/result_19.png}
\end{minipage}
...
\hyperdef{}{Ex-15-3}{\paragraph{}\label{Ex-15-3}}
...
\hfill{} \hyperref[Ans-15-3]{Answer Available}
...
\hyperdef{}{Ex-15-9}{\paragraph{}\label{Ex-15-9}}
...
\hfill{} \hyperref[Ans-15-9]{Answer Available}
...
\hyperdef{}{Ex-15-12}{\paragraph{}\label{Ex-15-12}}
...
\hfill{} \hyperref[Ans-15-12]{Answer Available}

\completeEx 

\hyperdef{}{Ex-15-13}{\paragraph{}\label{Ex-15-13}}
...
\hfill{} \hyperref[Ans-15-13]{Answer Available}

\completeEx 

\hyperdef{}{Ex-15-14}{\paragraph{}\label{Ex-15-14}}
...
\hfill{} \hyperref[Ans-15-14]{Answer Available}

\completeEx 

\hyperdef{}{Ex-15-15}{\paragraph{}\label{Ex-15-15}}

\beginEx{Exercise 15-15}
...
\hfill{} \hyperref[Ans-15-15]{Answer Available}
...
\hyperdef{}{Ex-15-16}{\paragraph{}\label{Ex-15-16}}

\beginEx{Exercise 15-16}
...
\hfill{} \hyperref[Ans-15-16]{Answer Available}

\completeEx 

\hyperdef{}{Ex-15-17}{\paragraph{}\label{Ex-15-17}}

\beginEx{Exercise 15-17}
...
\hfill{} \hyperref[Ans-15-17]{Answer Available}

\completeEx 

\hyperdef{}{Ex-15-18}{\paragraph{}\label{Ex-15-18}}

\beginEx{Exercise 15-18}
...
\hfill{} \hyperref[Ans-15-18]{Answer Available}
...
\hyperdef{}{Ex-15-19}{\paragraph{}\label{Ex-15-19}}

\beginEx{Exercise 15-19}
...
\hfill{} \hyperref[Ans-15-19]{Answer Available}

\completeEx 

\hyperdef{}{Ex-15-20}{\paragraph{}\label{Ex-15-20}}

\beginEx{Exercise 15-20}
...
\hfill{} \hyperref[Ans-15-20]{Answer Available}

\completeEx 

\hyperdef{}{Ex-15-21}{\paragraph{}\label{Ex-15-21}}

\beginEx{Exercise 15-21}
...
\hfill{} \hyperref[Ans-15-21]{Answer Available}
...
\hyperdef{}{Ex-16-1}{\paragraph{}\label{Ex-16-1}}

\beginEx{Exercise 16-1}
...
\hfill{} \hyperref[Ans-16-1]{Answer Available}

\completeEx 

\hyperdef{}{Ex-16-2}{\paragraph{}\label{Ex-16-2}}

\beginEx{Exercise 16-2}
...
\hfill{} \hyperref[Ans-16-2]{Answer Available}

\completeEx 

\hyperdef{}{Ex-16-3}{\paragraph{}\label{Ex-16-3}}

\beginEx{Exercise 16-3}

Describe why this is not a valid equation to calculate error:

\lstinline![Simulated]-[Historical]!

\hfill{} \hyperref[Ans-16-3]{Answer Available}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/diagram_4.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/result_6.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/diagram_13.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/result_20.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/result_23.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/diagram_29.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/result_34.png}
\end{minipage}
...
\hyperdef{}{Ex-16-7}{\paragraph{}\label{Ex-16-7}}

\beginEx{Exercise 16-7}

Adjust the JavaScript code to calculate pseudo $R^2$ to use absolute
value error instead of squared error.

\hfill{} \hyperref[Ans-16-7]{Answer Available}

\completeEx 

\paragraph{}

\beginEx{Exercise 16-8}
...
\hyperdef{}{Ex-16-10}{\paragraph{}\label{Ex-16-10}}

\beginEx{Exercise 16-10}
...
\hfill{} \hyperref[Ans-16-10]{Answer Available}

\completeEx 

\paragraph{}

\beginEx{Exercise 16-11}
...
\hyperdef{}{Ex-17-2}{\paragraph{}\label{Ex-17-2}}

\beginEx{Exercise 17-2}
...
\hfill{} \hyperref[Ans-17-2]{Answer Available}

\completeEx 

\paragraph{}

\beginEx{Exercise 17-3}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_40/diagram_6.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_40/diagram_13.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_40/result_24.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_41/diagram_11.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_41/result_13.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_41/result_15.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_41/result_18.png}
\end{minipage}
...
\hyperdef{}{Ex-17-4}{\paragraph{}\label{Ex-17-4}}

\beginEx{Exercise 17-4}

Given a vector of heights \lstinline!2, 1.8, 1.9, 1.5!, write an
equation to find the tallest height under 1.95 meters:

\hfill{} \hyperref[Ans-17-4]{Answer Available}

\completeEx 

\hyperdef{}{Ex-17-5}{\paragraph{}\label{Ex-17-5}}

\beginEx{Exercise 17-5}

Given a vector named \emph{a}, write an equation to find the median of
the squares of all the elements in \emph{a}.

\hfill{} \hyperref[Ans-17-5]{Answer Available}

\completeEx 

\hyperdef{}{Ex-17-6}{\paragraph{}\label{Ex-17-6}}

\beginEx{Exercise 17-6}
...
\hfill{} \hyperref[Ans-17-6]{Answer Available}

\completeEx 

\hyperdef{}{Ex-17-7}{\paragraph{}\label{Ex-17-7}}

\beginEx{Exercise 17-7}

Given the vector named \emph{a}. Find the mean of the vector without
using the \lstinline!Mean()! function.

\hfill{} \hyperref[Ans-17-7]{Answer Available}
...
\lstinline!FindState([Population], [Infected])!

And we could obtain a vector of the agents that were not currently
infected with:

\lstinline!FindNotState([Population], [Infected])!
...
\lstinline!FindState(FindState([Population], [Infected]), [Male])!
...
\lstinline!Union(FindState([Population], [Infected]), FindState([Population], [Male]))!

If you wanted the agents that were either infected or men (but not both
simultaneously), you could use:

\lstinline!Difference(FindState([Population], [Infected]), FindState([Population], [Male]))!

\hyperdef{}{Ex-17-8}{\paragraph{}\label{Ex-17-8}}

\beginEx{Exercise 17-8}

Write an equation using the disease example to return a vector of all
female infected individuals.

\hfill{} \hyperref[Ans-17-8]{Answer Available}

\completeEx 

\hyperdef{}{Ex-17-9}{\paragraph{}\label{Ex-17-9}}

\beginEx{Exercise 17-9}

Write an equation using the disease example to return a vector of all
female individuals, healthy individuals or healthy females.

\hfill{} \hyperref[Ans-17-9]{Answer Available}
...
\lstinline!Value(FindAll([Population]), [Height])!
...
\lstinline!Mean(Value(FindAll([Population]), [Height]))!
...
\lstinline!SetValue(FindAll([Population]), [Height], 2.1)!

\hyperdef{}{Ex-17-10}{\paragraph{}\label{Ex-17-10}}

\beginEx{Exercise 17-10}
...
\hfill{} \hyperref[Ans-17-10]{Answer Available}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/diagram_3.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/diagram_8.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/result_15.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/result_21.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/result_23.png}
\end{minipage}
...
\lstinline!Move([Self], {rand(), rand()!-0.5)\}
...
of another agent. MoveTowards takes three arguments: the agent to be
moved, the target agent to move towards, and how far to move towards
that agent (with negative values indicating movement away). The
following command would move an agent one meter closer to its nearest
neighbor in the population.

\lstinline!MoveTowards([Self], FindNearest([Population], [Self]), {1 Meter})!

\hyperdef{}{Ex-17-11}{\paragraph{}\label{Ex-17-11}}

\beginEx{Exercise 17-11}

Write an equation to move an agent 2 meters towards the furthest healthy
agent.

\hfill{} \hyperref[Ans-17-11]{Answer Available}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_43/diagram_3.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_43/diagram_10.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_43/result_17.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_43/result_20.png}
\end{minipage}
...
\hyperdef{}{Ex-17-12}{\paragraph{}\label{Ex-17-12}}

\beginEx{Exercise 17-12}
...
\hfill{} \hyperref[Ans-17-12]{Answer Available}

\completeEx 

\hyperdef{}{Ex-17-13}{\paragraph{}\label{Ex-17-13}}

\beginEx{Exercise 17-13}
...
\hfill{} \hyperref[Ans-17-13]{Answer Available}
...
\hyperdef{}{Ex-18-1}{\paragraph{}\label{Ex-18-1}}

\beginEx{Exercise 18-1}

Replicate the following formatting in an HTML document:

This \textbf{text is \emph{italic} and bold.}

\hfill{} \hyperref[Ans-18-1]{Answer Available}

\completeEx 

\hyperdef{}{Ex-18-2}{\paragraph{}\label{Ex-18-2}}

\beginEx{Exercise 18-2}
...
\hfill{} \hyperref[Ans-18-2]{Answer Available}

\completeEx 

\paragraph{}

\beginEx{Exercise 18-3}
...
\hyperdef{}{Ex-18-6}{\paragraph{}\label{Ex-18-6}}

\beginEx{Exercise 18-6}

Learn about JavaScript online. Create a script that prompts the user for
two numbers and then adds them.

\hfill{} \hyperref[Ans-18-6]{Answer Available}
...
\hyperdef{}{Ex-18-7}{\paragraph{}\label{Ex-18-7}}

\beginEx{Exercise 18-7}

Use CSS to make a rule to automatically underline the headings in this
web page.

\hfill{} \hyperref[Ans-18-7]{Answer Available}

\completeEx 

\hyperdef{}{Ex-18-8}{\paragraph{}\label{Ex-18-8}}

\beginEx{Exercise 18-8}

Use CSS to add a background color to this page.

\hfill{} \hyperref[Ans-18-8]{Answer Available}

\completeEx 

\paragraph{}

\beginEx{Exercise 18-9}
...
\hyperdef{}{Ex-18-10}{\paragraph{}\label{Ex-18-10}}

\beginEx{Exercise 18-10}

Use CSS to change the style of the inputs. Make inputs have a yellow
background and blue text.

\hfill{} \hyperref[Ans-18-10]{Answer Available}

\completeEx 

\hyperdef{}{Ex-18-11}{\paragraph{}\label{Ex-18-11}}

\beginEx{Exercise 18-11}
...
\hfill{} \hyperref[Ans-18-11]{Answer Available}

\completeEx 

\paragraph{}

\beginEx{Exercise 18-12}
...
\hyperdef{}{Ans-4-4}{\subsection{\hyperref[Ex-4-4]{Exercise
4-4}}\label{Ans-4-4}}
...
\hyperdef{}{Ans-4-6}{\subsection{\hyperref[Ex-4-6]{Exercise
4-6}}\label{Ans-4-6}}
...
\hyperdef{}{Ans-6-3}{\subsection{\hyperref[Ex-6-3]{Exercise
6-3}}\label{Ans-6-3}}
...
\hyperdef{}{Ans-6-4}{\subsection{\hyperref[Ex-6-4]{Exercise
6-4}}\label{Ans-6-4}}
...
\hyperdef{}{Ans-6-5}{\subsection{\hyperref[Ex-6-5]{Exercise
6-5}}\label{Ans-6-5}}
...
\hyperdef{}{Ans-15-3}{\subsection{\hyperref[Ex-15-3]{Exercise
15-3}}\label{Ans-15-3}}
...
\hyperdef{}{Ans-15-9}{\subsection{\hyperref[Ex-15-9]{Exercise
15-9}}\label{Ans-15-9}}
...
\hyperdef{}{Ans-15-12}{\subsection{\hyperref[Ex-15-12]{Exercise
15-12}}\label{Ans-15-12}}

Eigenvalue of 6 with eigenvector of $[1,1]$. Eigenvalue of -2 with
eigenvector of $[-1,1]$.

\hyperdef{}{Ans-15-13}{\subsection{\hyperref[Ex-15-13]{Exercise
15-13}}\label{Ans-15-13}}

Eigenvalue of 2 with eigenvector of $[1,5]$. Eigenvalue of 1 with
eigenvector of $[0,1]$.

\hyperdef{}{Ans-15-14}{\subsection{\hyperref[Ex-15-14]{Exercise
15-14}}\label{Ans-15-14}}

Eigenvalue of $\alpha-\beta$ with eigenvector of $[-1,1]$. Eigenvalue of
$\beta+\alpha$ with eigenvector of $[1,1]$.

\hyperdef{}{Ans-15-15}{\subsection{\hyperref[Ex-15-15]{Exercise
15-15}}\label{Ans-15-15}}

Eigenvalue of $\alpha$ with eigenvector of $[1,0]$. Eigenvalue of
$\beta$ with eigenvector of
$\left[\frac{-\beta}{\alpha-\beta},1 \right]$.

\hyperdef{}{Ans-15-16}{\subsection{\hyperref[Ex-15-16]{Exercise
15-16}}\label{Ans-15-16}}
...
\hyperdef{}{Ans-15-17}{\subsection{\hyperref[Ex-15-17]{Exercise
15-17}}\label{Ans-15-17}}
...
\hyperdef{}{Ans-15-18}{\subsection{\hyperref[Ex-15-18]{Exercise
15-18}}\label{Ans-15-18}}
...
\hyperdef{}{Ans-15-19}{\subsection{\hyperref[Ex-15-19]{Exercise
15-19}}\label{Ans-15-19}}

Equilibrium $X=2, Y=-2$ is unstable.

$X=0, Y=-2$ is an unstable saddle point.

\hyperdef{}{Ans-15-20}{\subsection{\hyperref[Ex-15-20]{Exercise
15-20}}\label{Ans-15-20}}
...
\hyperdef{}{Ans-15-21}{\subsection{\hyperref[Ex-15-21]{Exercise
15-21}}\label{Ans-15-21}}
...
\hyperdef{}{Ans-16-1}{\subsection{\hyperref[Ex-16-1]{Exercise
16-1}}\label{Ans-16-1}}
...
\hyperdef{}{Ans-16-2}{\subsection{\hyperref[Ex-16-2]{Exercise
16-2}}\label{Ans-16-2}}

\lstinline!([Simulated]-[Historical])^4!

\hyperdef{}{Ans-16-3}{\subsection{\hyperref[Ex-16-3]{Exercise
16-3}}\label{Ans-16-3}}
...
\hyperdef{}{Ans-16-7}{\subsection{\hyperref[Ex-16-7]{Exercise
16-7}}\label{Ans-16-7}}
...
\hyperdef{}{Ans-16-10}{\subsection{\hyperref[Ex-16-10]{Exercise
16-10}}\label{Ans-16-10}}
...
\hyperdef{}{Ans-17-2}{\subsection{\hyperref[Ex-17-2]{Exercise
17-2}}\label{Ans-17-2}}
...
\hyperdef{}{Ans-17-4}{\subsection{\hyperref[Ex-17-4]{Exercise
17-4}}\label{Ans-17-4}}

\lstinline!Max(Filter({2, 1.8, 1.9, 1.5}, x < 1.95))!

\hyperdef{}{Ans-17-5}{\subsection{\hyperref[Ex-17-5]{Exercise
17-5}}\label{Ans-17-5}}

\lstinline!Median(a^2)!

\hyperdef{}{Ans-17-6}{\subsection{\hyperref[Ex-17-6]{Exercise
17-6}}\label{Ans-17-6}}

\lstinline!Min(Intersection(a, b))!

\hyperdef{}{Ans-17-7}{\subsection{\hyperref[Ex-17-7]{Exercise
17-7}}\label{Ans-17-7}}

\lstinline!Sum(a)/Count(a)!

\hyperdef{}{Ans-17-8}{\subsection{\hyperref[Ex-17-8]{Exercise
17-8}}\label{Ans-17-8}}

\lstinline!FindState(FindState([Population], [Infected]), [Female])!

\hyperdef{}{Ans-17-9}{\subsection{\hyperref[Ex-17-9]{Exercise
17-9}}\label{Ans-17-9}}

\lstinline!Union(FindNotState([Population], [Infected]), FindState([Population], [Female]))!

\hyperdef{}{Ans-17-10}{\subsection{\hyperref[Ex-17-10]{Exercise
17-10}}\label{Ans-17-10}}

\lstinline!Mean(Value(FindState([Population], [Male]), [Height]))-Mean(Value(FindState([Population], [Female]), [Height]))!

\hyperdef{}{Ans-17-11}{\subsection{\hyperref[Ex-17-11]{Exercise
17-11}}\label{Ans-17-11}}

\lstinline!MoveTowards([Self], FindFurthest(FindState([Population, [Healthy]), [Self]), {2 Meters})!

\hyperdef{}{Ans-17-12}{\subsection{\hyperref[Ex-17-12]{Exercise
17-12}}\label{Ans-17-12}}
...
\hyperdef{}{Ans-17-13}{\subsection{\hyperref[Ex-17-13]{Exercise
17-13}}\label{Ans-17-13}}
...
\hyperdef{}{Ans-18-1}{\subsection{\hyperref[Ex-18-1]{Exercise
18-1}}\label{Ans-18-1}}
...
\hyperdef{}{Ans-18-2}{\subsection{\hyperref[Ex-18-2]{Exercise
18-2}}\label{Ans-18-2}}
...
\hyperdef{}{Ans-18-4}{\subsection{\hyperref[Ex-18-4]{Exercise
18-4}}\label{Ans-18-4}}
...
\hyperdef{}{Ans-18-5}{\subsection{\hyperref[Ex-18-5]{Exercise
18-5}}\label{Ans-18-5}}
...
\hyperdef{}{Ans-18-6}{\subsection{\hyperref[Ex-18-6]{Exercise
18-6}}\label{Ans-18-6}}
...
\hyperdef{}{Ans-18-7}{\subsection{\hyperref[Ex-18-7]{Exercise
18-7}}\label{Ans-18-7}}
...
\hyperdef{}{Ans-18-8}{\subsection{\hyperref[Ex-18-8]{Exercise
18-8}}\label{Ans-18-8}}
...
\hyperdef{}{Ans-18-10}{\subsection{\hyperref[Ex-18-10]{Exercise
18-10}}\label{Ans-18-10}}
...
\hyperdef{}{Ans-18-11}{\subsection{\hyperref[Ex-18-11]{Exercise
18-11}}\label{Ans-18-11}}
