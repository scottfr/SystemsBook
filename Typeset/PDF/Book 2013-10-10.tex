...
skip around as your interest directs.

Expand Intro to present insight into what's about to be experienced, and
do it as an insght maker model. Check out the approach for Horn's mural.
...
\subsection{The Future We Create}
...
they become readily apparent all around us.
...
here that's relevant to what's happening and essential to include for
the understanding we're trying to achieve.

\section{tbd / Pedro Almaguer}

\section{tbd / Lory Antonucci}

\section{tbd / Hugh Campbell}

\section{tbd / Jamie Chapman}

\section{tbd / Stephen Hobs}

\section{Restaurant Covers / Lise Inman}
...
\section{tbd / Justin Lyon}

\section{tbd / Mike Parker}

\section{tbd / David Patterson}

\section{tbd / Anand Rao}

\section{To Degree or Not / Matt Sadinsky}
...
\section{Sustainable Capitalism / Ken Shepard}
...
the reasons behind this? This model is from Mark Van Clieaf sponsored by
Ken Shepard.
...
\section{tbd / Janet Singer}

\section{tbd / Raji Sirajuddin}

\section{tbd / Ben Taylor}

\section{tbd / Raid Mahmoud Zaini}
...
possible to model very intangible things. You will find that some of the
most influential aspects of the models you will build in the future are
actually the intangibles.
...
atmospheric CO2 stabilise at about 400 ppmv in 2100.\footnote{Climate
  Stabilization Task \url{http://insightmaker.com/insight/9283}.}
\{cite: Sterman, John D. (2008) Risk Communication on Climate: Mental
Models and Mass Balance. Science 322 (24 October): 532-533\}
...
\begin{model}[frametitle={Model: An Infinite Number of Drinkers}] 
...
we have seen (will see? XXX) this is what tools like reference models
and pattern matching are designed to do efficiently: elicit a narrative
from a subject in a way which can be reformulated quantitatively.
...
(1978). This approach states that no single test or suite of tests will
...
Although not as much a lightning rod as is model design, significant
errors can occur during implementation of a model specification. Bugs
...
to exhibit the correct behavior. Development of such tests is a common
practice in software engineering that we would like to see more of in
model development. Insight Maker itself has a suite of more than 1,000
individual regression tests that automatically test every aspect of its
simulation engine.
...
step to show how those results were correct and mirrored reality, that
could well increase their confidence in the model results.
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_35/diagram_11.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_35/result_13.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_35/result_19.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_35/result_21.png}
\end{minipage}
...
\item \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_35/data_25.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_36/result_17.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_36/result_26.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_37/diagram_7.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_37/result_15.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_37/result_19.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/diagram_4.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/result_6.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/result_20.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/result_23.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/diagram_29.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_38/result_34.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/diagram_6.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/result_21.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_39/result_24.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_40/diagram_11.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_40/result_13.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_40/result_18.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_41/diagram_8.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_41/result_21.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_41/result_23.png}
\end{minipage}
...
\item The model diagram should now look something like this: \par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/diagram_10.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/result_17.png}
\end{minipage}
...
\item Run the model. Here are sample results:\par \begin{minipage}{\linewidth}  \centering \includegraphics{model_42/result_20.png}
\end{minipage}
