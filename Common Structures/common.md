...
The chapter provides an introduction to the explicit relationships between the most commonly recurring structures along with their natural evolution paths. The next two chapters will provide a detailed investigation of these structures along with their characteristic pattern of behavior which will help you recognize and address them.
