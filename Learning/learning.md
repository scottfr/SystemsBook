...
When we experience something, that experience falls somewhere between complete novelty, meaning that we can't connect it with anything in our past experience, and complete confirmation, meaning that it represents something we already believe we completely understand. Experiences which lie somewhere between complete novelty and complete confirmation provide a basis for learning. They represent a basis for connecting to understood patterns and extending those patterns and our understanding. What results is learning [@Jantsch:1980tr].
...
"Essence Property # 1^[Essence Property # 1 [http://insightmaker.com/insight/4957](http://insightmaker.com/insight/4957)]" should provide a very different view of the world around you.
...
In previous sections you interacted with two different kinds of modelsin all the simulation models you ran: qualitative models (no numbers - "Follow the Clues" and "Bird Feeder Dilemma") and quantitative models (with numbers). In the "Three Types of Models"^[Three Types of Models [http://insightmaker.com/insight/8932](http://insightmaker.com/insight/8932)] ILE we'll present two types of qualitative models: Rich Pictures and Causal Loop Diagrams. We will also provide more detail about quantitative Stock & Flow Simulation Models.
...
While there are endless reasons for constructing a model, it all boils down to learning and understanding. The "Model Construction Process"^[Model Construction Process [http://insightmaker.com/insight/184](http://insightmaker.com/insight/184)] model is intended to present the essence of all model development.
